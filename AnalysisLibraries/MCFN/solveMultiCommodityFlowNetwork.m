function solveMultiCommodityFlowNetwork(FlowNetwork)
    ...
    FlowNetwork.FlowEdge_Solution = [MCFNsolution(length(FlowNetwork.FlowEdge_flowTypeAllowed)+1 : end), FlowNetwork.FlowEdgeSet]; %Should reduce to only selected edges
